...
class PieChartEtudiantWidget extends StatefulWidget {
  const PieChartEtudiantWidget({Key? key}) : super(key: key);

  @override
  _PieChartEtudiantWidgetState createState() => _PieChartEtudiantWidgetState();
}

class _PieChartEtudiantWidgetState extends State<PieChartEtudiantWidget> {
  List<String> _labels = [];
  List<int> _data = [];
  int sumData = 0;
  ...
  Future<void> _getData() async {
    ...
    final response = await http.get(Uri.parse('${API.Etudiant_by_niveau}'),
        headers: {
