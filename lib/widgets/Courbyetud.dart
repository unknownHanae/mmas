...
class PieChartCourWidget extends StatefulWidget {
  const PieChartCourWidget({Key? key}) : super(key: key);

  @override
  _PieChartCourWidgetState createState() => _PieChartCourWidgetState();
}

class _PieChartCourWidgetState extends State<PieChartCourWidget> {
  List<String> _labels = [];
  List<int> _data = [];
  int sumData = 0;
  ...
  Future<void> _getData() async {
    ...
    final response = await http.get(Uri.parse('${API.cours_by_etud}'),
        headers: {
