...
import 'package:adminmmas/views/presenceScreen1.dart';
    ...
    if (details.targetElement == CalendarElement.appointment ||
      ...
      Navigator.of(context).push(
        MaterialPageRoute(builder: (context) =>
            interface1(classe_id: seance.id_classe!, seance_id: seance.id_seance!,  prof_id: seance.id_prof!,date_presence: appointmentDetails.date_reservation,sean_info:seance)
        ),
      ).then((value) {
        setState(() {
          _future = getDataFromWeb();
