...
//
// class CloneNotificationStepper extends StatefulWidget {
//   final Function onNotificationUpdated;
//
//   NotificationAdmin notificationAdmin;
//   List<dynamic> clients;
//
//   CloneNotificationStepper({required this.onNotificationUpdated, required this.notificationAdmin, required this.clients});
//   @override
//   _CloneNotificationStepperState createState() => _CloneNotificationStepperState();
// }
//
// enum ReceiverType {
//   client,
...
//
// class _CloneNotificationStepperState extends State<CloneNotificationStepper> {
//   // controller
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('Dupliquer une notification'),
//       ),
//       body: Form(
//         key: _formKey,
//         child: Padding(
...
//               builder: (context) => AlertDialog(
//                 title: Text('Succès'),
//                 content: Text('Notification a été dupliquée avec succès.'),
