...
class CatContratScreen extends StatefulWidget {
  ...
  @override
  State<CatContratScreen> createState() => _CatContratScreenState();
}

class _CatContratScreenState extends State<CatContratScreen> {
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Center(child: Text("categories des contrats", style: TextStyle(
                                    fontSize: 18,
                                  ...
                                  child: ListView(
                                      children:[
                                        ...
                                        Padding(
                                          ...
                                          child: Center(
                                              child: Text("aucune Catégorie Contrat à afficher")),
                                        )
                                            :
                                        DataTable(
