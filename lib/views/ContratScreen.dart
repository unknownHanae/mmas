...
class ContratScreen extends StatefulWidget {
  ContratScreen({Key? key, Client? this.client, String? this.from}) : super(key: key);
...
*/
  ...
  void initData(){
    ...
    if(_selectTypeContrat.getSelected()!= null){
      _selectTypeContrat.removeSelected(_selectTypeContrat.getSelected()!);
    }
  ...
  void add(context) async {
    ...
    //&& reduction_controller.text.isNotEmpty
    && _selectTypeContrat.getSelected()?.getValue() != null
    ){
      ...
      var rev = <String, dynamic>{
        ...
        "id_admin": admin!.id,
        "type": _selectTypeContrat.getSelected()?.getValue(),
        "reduction": reduction_controller.text.isNotEmpty ? reduction_controller.text : 0,
      };
                              ...
                              Montant_controller.text.isNotEmpty
                                ...
                                items.add(
                                    Row(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("Type Contrat: ", style: TextStyle(fontWeight: FontWeight.bold)),
                                        SizedBox(width: 15,),
                                        Text("${_selectTypeContrat.getSelected()?.getValue()} ")
                                      ],
                                    )
                                );
                                items.add(
                                    Row(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("Reduction ", style: TextStyle(fontWeight: FontWeight.bold)),
                                        SizedBox(width: 15,),
                                        Text("${reduction_controller.text.isNotEmpty ? reduction_controller.text : 0} Dhs")
                                      ],
                                    )
                                );
                                items.add(
                                    ...
                                    Expanded(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            BsSelectBox(
                                              hintText: 'Type de Contrat',
                                              controller: _selectTypeContrat,
                                              onChange: (v){
                                          ...
                                          children: [
                                            ...
                                            BsSelectBox(
                                              ...
                                              onChange: (v){
                                                ...
                                                var enable = abn.duree_mois != null ?
                                                abn.duree_mois == 10 ? false : true : true;

                                                setState(() {
                                                  _enableDateStart = enable;
                                                });

                                                tarif_controller.text = abn.tarif!;
                                                restNew_controller.text = abn.tarif!;
                                                ...
                                                if(enable){
                                                  if(date_debut_controller.text.isEmpty){
                                                    ...
                                                    String formattedDateFin = DateFormat("yyyy-MM-dd").format(date_fin);
                                                    date_fin_controller.text = formattedDateFin;
                                                  }
                                                }else{
                                                  DateTime currentDate = DateTime(DateTime.now().month >= DateTime.september ? DateTime.now().year  : DateTime.now().year-1, DateTime.september);
                                                  DateTime date_fin = Jiffy(currentDate).add(months: abn.duree_mois!-1, days: 29).dateTime;
                                                  String formattedDateDebut = DateFormat("yyyy-MM-dd").format(currentDate);
                                                  String formattedDateFin = DateFormat("yyyy-MM-dd").format(date_fin);
                                                  date_debut_controller.text = formattedDateDebut;
                                                  date_fin_controller.text = formattedDateFin;
                                                }
                                                Navigator.pop(context);
                                                modal_add2(context);
                                              ...
                                              children: [
                                                Expanded(
                                                  child: Container(
                                                      ...
                                                      child: TextField(
                                                        controller: reduction_controller,
                                                        ...
                                                        onChanged: (v){
                                                          ...
                                                          if(reduction_controller.text.isNotEmpty){
                                                            var redution = double.parse(reduction_controller.text);
                                                            if(tarif_controller.text.isNotEmpty){
                                                              var tarif = double.parse(tarif_controller.text);
                                                              if(redution > 0  && redution <= tarif){
                                                                tarif -= redution;
                                                                restNew_controller.text = "${tarif}";
                                                                setState(() {
                                                                  reste_paye = tarif;
                                                                });
                                                    ...
                                                    onChanged: (value){
                                                      ...
                                                      try{
                                                        ...
                                                        if(montant>0 && montant<=tarif){
                                                          ...
                                                          restNew_controller.text=s_tarif;
                                                          setState(() {
                                                            showAlert = true;
                                                          });
                                                          Navigator.pop(context);
  ...
  void print_pdf(int id_contrat) async {
    var url = "${HOST}/api/generate_contrat/${id_contrat}";
    /*html.window.open(
    ...
    return Scaffold(
      body: Container(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
            //  SideBar(postion: 1111,msg:"Contrats"),
              SizedBox(width: 10,),
              Expanded(
                flex: 3,
                child: Column(
                          ...
                          child: Column(
                            children: [
                              Padding(
                                ...
                                child: Center(child: Text("Contrats Clients", style: TextStyle(
                                    fontSize: 18,
                              ...
                              Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  Text("Liste des Contrats étudiants", style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.w700,
                                      color: Colors.grey
                                  )),
                                              ...
                                              <DataCell>[
                                                DataCell(Row(
                                                  children: [
                                                    ...
                                                    SizedBox(width: 9,),
                                                    Expanded(
                                                      child: Text(" ${r.client.toString()} ${r.Prenom_client.toString()}",
                                                        overflow: TextOverflow.ellipsis,),
                                                    )
                                                ...
                                                //         "${r.date_fin}"
                                                //     )),
                                                DataCell(Text("${r.abonnement.toString()} - ${r.cat_abn.toString()}")),
