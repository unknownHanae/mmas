...
//
// class SeanceScreenCoach extends StatefulWidget {
//   const SeanceScreenCoach({Key? key}) : super(key: key);
//
//   @override
//   State<SeanceScreenCoach> createState() => _SeanceScreenState();
// }
//
// class _SeanceScreenState extends State<SeanceScreenCoach> {
//
//   List<Seance> data = [];
...
//       );
//       _selectCoach.setSelected(
//           BsSelectBoxOption(value: s.id_coach, text: Text(s.coach.toString()))
//       );
//       _selectSalles.setSelected(
...
//           child: Row(
//             children: [
//               SideBarCoachs(postion: 10,msg:"Coach"),
//               SizedBox(width: 10,),
//               Expanded(
//                 flex: 3,
//                 child: Column(
...
//                                 crossAxisAlignment: CrossAxisAlignment.center,
//                                 children: [
//                                   Text("Liste des Seances", style: TextStyle(
//                                       fontSize: 18,
